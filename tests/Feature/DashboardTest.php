...
class DashboardTest extends TestCase
{
	...
	public function test_unauthorized_user_should_redirect_to_login_page_if_tries_to_go_on_worldwide_page(): void
	{
		$response = $this->get(route('landings.worldwide'));
		$response->assertRedirect(route('auth.login_page'));
	}

	public function test_redirect_to_worldwide_page_if_authorized_user_visiting_login_page()
	{
