...
<body>
<div style="max-width: 520px;  margin: 12rem auto; background: white;">
    ...
    <div style="margin: 0 64px;">>
        ...
        <div style="text-align: center; margin-top: 2.5rem; background-color: #0FBA68; border-radius: 12px;">
            <a style="text-align: center; text-decoration: none; font-weight: 900; color: white; text-transform: uppercase; display: inline-block; width: 100%; padding: 20px 0;" href="{{$link}}"><span>{{$button}}</span></a>
        </div>
    </div>
</div>
</body>
